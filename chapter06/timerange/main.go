...
func main() {
	...
	flag.StringVar(&end, "e", "2006-01-02 15:04:05", "结束时间")
	...
	startStamp := startS.Unix()
	endS, _ := time.Parse("2006-01-02 15:04:05", end)
	endStamp := endS.Unix()
	timeRange := endStamp - startStamp
	timeRangeMin := timeRange / 60
	fmt.Printf("\nstartS=%v, endS=%v\ntimeRangeMin=%v\n", startStamp, endStamp, timeRangeMin)
}
